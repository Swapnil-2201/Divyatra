...
export default function handler(req, res) {
  ...
  try {
    const crowdOverview = {
      ...
      notice: "All telemetry values are generated by the DivYatra AI Simulation Engine for operational demonstration. Live AI inference is served via the local Edge Computer Vision Microservice.",
      isLiveAI: false,
